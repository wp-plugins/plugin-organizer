...
if ( current_user_can( 'activate_plugins' ) ) {
	...
	<script type="text/javascript" language="javascript">
		function PO_submit_search_plugins(){
			...
			jQuery.post(encodeURI(ajaxurl + '?action=PO_save_search_plugins'), { 'disabledList[]': disabledList, 'disabledMobileList[]': disabledMobileList, 'disabledGroupList[]': disabledGroupList, 'disabledMobileGroupList[]': disabledMobileGroupList, PO_nonce: '<?php print $this->nonce; ?>' }, function (result) {
				alert(result);
